...
const ToAddress = ({stage, address, ...props}) => (
  <div>
    <Row align="center">
      <h3 style={{paddingBottom: 30}}>Enter to address</h3>
    </Row>
    <Form horizontal onSubmit={(event) => props.handleSubmit(event, stage)}>
      ...
      <FormGroup style={{paddingTop: 20}}>
        <Col smOffset={3} sm={3} >
          <Button bsStyle="primary" onClick={() => props.handlePrevious(stage)}>Previous Step</Button>
        </Col>
        <Col smOffset={1} sm={3} >
